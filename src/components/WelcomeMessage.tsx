      ...
      <Card className="w-full max-w-md shadow-xl">
        ...
        <CardContent className="text-center">
          <p className="text-foreground">
            Start your adventure by uploading the first images (1-4) for your comic's initial panel. From there, you can generate new panels, create branching storylines, and explore endless possibilities with AI.
          </p>
        </CardContent>
        <CardFooter>
          <Button size="lg" className="w-full" onClick={onUploadInitial}>
            <FileUp className="mr-2 h-5 w-5" />
            Upload Your First Comic Panel Images
          </Button>
        </CardFooter>
      </Card>
    </div>
